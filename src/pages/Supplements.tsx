...
export default function SupplementsPage() {
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <section className="pt-48 sm:pt-56 pb-16 sm:pb-20 bg-gradient-to-b from-purple-500/10 to-background relative overflow-hidden">
            ...
            <section className="py-12 relative">
                ...
                <div className="container mx-auto px-4 lg:px-8 relative z-10">
                    <p className="text-sm text-muted-foreground mb-6">
                        Showing {groupedProducts.length} supplement products
                    </p>
...
function ProductCard({ variants, index, addToCart }: { variants: Product[]; index: number; addToCart: any }) {
    ...
    return (
        ...
        >
            <div className="relative h-40 sm:h-48 flex items-center justify-center p-4 sm:p-6 bg-purple-500/5">
                ...
                <span className="absolute top-2 sm:top-3 left-2 sm:left-3 px-2 py-1 rounded-full text-xs font-medium bg-purple-500/10 text-purple-600">
                    Supplements
                </span>
            </div>
                        ...
                        {variants.map((variant) => (
                            <button
                                ...
                                className={cn(
                                    ...
                                    selectedVariant.id === variant.id && "ring-2 ring-purple-500 scale-110"
                                )}
