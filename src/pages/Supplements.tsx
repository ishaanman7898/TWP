    ...
    return (
        <div className="min-h-screen bg-black text-white">
            ...
            <section className="relative h-screen flex items-center justify-center overflow-hidden pt-20">
                <HeroTubesCursor theme="purple" />
                <div className="absolute inset-0 bg-gradient-to-b from-purple-900/40 via-black/80 to-black z-[1]"></div>
                ...
                <div className="relative z-10 text-center px-4">
                    ...
                    <p className="text-xl md:text-2xl text-white/70 max-w-2xl mx-auto font-light mb-8">
                        Premium formulas designed to support hydration, recovery, and performance.
                    </p>
                </div>
