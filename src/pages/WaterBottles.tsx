    ...
    return (
        <div
            className={cn(
                ...
                "bg-card border border-border hover:border-sky-500/50",
                "hover:shadow-2xl hover:shadow-sky-500/10 hover:-translate-y-2",
                "animate-fade-in-up"
            )}
            style={{ animationDelay: `${index * 50}ms` }}
        >
            <div className="relative h-40 sm:h-48 flex items-center justify-center p-4 sm:p-6 bg-sky-500/5">
                ...
                <span className="absolute top-2 sm:top-3 left-2 sm:left-3 px-2 py-1 rounded-full text-xs font-medium bg-sky-500/10 text-sky-600">
                    Water Bottles
                </span>
            </div>
                        ...
                        {variants.map((variant) => (
                            <button
                                ...
                                className={cn(
                                    ...
                                    selectedVariant.id === variant.id && "ring-2 ring-sky-500 scale-110",
